                    ...
                    <div class="grid gap-2 grid-cols-1 lg:grid-cols-1">
                        <div class="bg-white p-4 shadow-lg rounded-lg">
                            <div class="flex justify-between">
                                ...
                                <button class="bg-green-400 p-3 rounded-lg shadow-md">add new posts</button>
                            </div>
                            <div class="mt-4">
...
<script>
    $(document).ready(function () {
        var URLROOT = 'http://localhost/MokhlisBelhaj_Alpha/Home';
                    ...
                    var row = '<tr>' +
                        ...
                        `<td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                            <div class="flex space-x-4">
                                <a href="${URLROOT}/posts/${post.id}" class="text-blue-500 hover:text-blue-600">
...
<script>
        function generatePDF() {
            ...
            var pdf = html2pdf(element,{filename:'dashboard.pdf'});
            ;}
        }
    </script>
